...
## Demo
![demo-1](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/6139d4f4-60d3-40cc-ad16-59cf2fcaf67a)
...
各スレッドでは最大5つのコメントが表示され、コメントが6つ以上ある場合は「すべてのコメント」をクリックすることで、スレッドのページに移動し、全てのコメント（最大500個）を見ることができます。また、スレッドや「返信」のアイコンをクリックすると、直接スレッドのページにアクセスできます。  
スレッドに添付されているサムネイルの画像をクリックすると、フルバージョンの画像を表示できます。

![demo-2](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/6ebebf59-4a76-49a4-8d42-e5a0ac4a1d9e)
...
![demo-3](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/b9a49fe8-129b-4303-b931-a3fc4c599f16)
...
#### アラートの例
![Screenshot 2023-12-26 at 19 18 20](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/4b0d4f21-c385-493e-8767-5274cabc061e)
...
![demo-4](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/5d27a3f0-26a7-4a60-8dc8-fa2acb40c426)
...
#### アラートの例
![Screenshot 2023-12-26 at 19 20 44](https://github.com/AkinoJoey/ImageboardWebapp/assets/124570638/5d7d3075-77fb-46c5-b44d-215357a39e15)
...
## こだわった点
### データアクセスオブジェクトの導入
当プロジェクトではデータアクセス層の抽象化のためにDAO(データアクセスオブジェクト)を導入しました。  
